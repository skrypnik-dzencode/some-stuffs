...
системы, и должны быть тесно связаны только друг с другом. Возможно, этот может немного ввести в заблуждение, так как мы
только что рассмотрели _Low coupling principe_, который наоборот, говорит о необходимости слабой связанности.

> Дело в том, что проблематика появляется из-за терминологии, которая употребляется в разных источниках. К примеру, термин
