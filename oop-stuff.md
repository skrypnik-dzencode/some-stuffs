...
Как многие знают - это аббревиатура, состоящая из первых букв пяти базовых принципов ООП и дизайна,
[предложенных](http://butunclebob.com/ArticleS.UncleBob.PrinciplesOfOod) Робертом Мартином (Uncle Bob)
...
Казалось бы просто, однако, как всегда, есть нюанс. Рассмотрим на примере. Мы пишем некий логгер (Logger)
