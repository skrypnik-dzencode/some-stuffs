...
отношение означает, что один объект является составной частью другого объекта. Как фотоаппарат и объектив.
...
создаётся вне объекта "фотоаппарат" и передаётся в конструктор или сеттер извне - это **агрегация**.
