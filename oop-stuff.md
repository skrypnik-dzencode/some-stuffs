...
Данный принцип говорит нам, что класс должен обладать единой ответственностью. Например, класс, отвечающий за оформление
...
Казалось бы просто, однако, как всегда, есть нюанс. Рассмотрим на примере. Мы пишем некий логгер (Logger), задача которого фиксировать действия пользователя.
Ответственность тут одна - фиксировать логи, НО, фиксировать их можно как в БД, так и в файл, так и по АПИ отправлять - следовательно ответственностей тут может быть несколько.
Так соблюдён ли тут **SPR**? - как всегда, "дьявол кроется в деталях". Согласно все тому же Дяде Бобу **_принцип единой ответственности_**
